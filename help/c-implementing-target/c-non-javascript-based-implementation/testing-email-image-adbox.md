...
|`mboxDefault={http%3A%2F%2Fwww.domain.com%2Fheader.jpg}`|Required. Replace the URL with appropriate default content for the adbox. This must be an absolute reference and must be URL encoded.|
